...
if __name__ == '__main__':
    ...
    filters_count_choices = [50, 100, 150]
    filters_length_choices = [[2, 3],
                              [2, 3, 4],
                              [2, 3, 4, 5]]
    space = {'hidden_layers': hp.choice('hidden_layers', hidden_layers_choices),
             ...
             'filters_count': hp.choice('filters_count', filters_count_choices),
             'filters_length': hp.choice('filters_length', filters_length_choices),
    ...
    best_params['filters_count'] = filters_count_choices[best_params['filters_count']]
    best_params['filters_length'] = filters_length_choices[best_params['filters_length']]
